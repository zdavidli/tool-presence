...
def compute_samples(data, num_samples):
    """ Sample from importance distribution z_samples ~ q(z|X) and
        ...
        From http://bjlkeng.github.io/posts/importance-sampling-and-estimating-marginal-likelihood-in-variational-autoencoders/
    """
...
def estimate_logpx_batch(dataloader, num_samples):
    """
    From http://bjlkeng.github.io/posts/importance-sampling-and-estimating-marginal-likelihood-in-variational-autoencoders/
    """
    data, _ = next(iter(dataloader))
    z_samples, pz, qz = compute_samples(data, num_samples)
    print(z_samples.shape, pz.shape, qz.shape)
